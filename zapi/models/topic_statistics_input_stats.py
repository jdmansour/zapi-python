...
T = TypeVar("T", bound="TopicStatisticsInputStats")


@_attrs_define
class TopicStatisticsInputStats:
    """
    Attributes:
        topic_uri (str):
        topic_url (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        topic_statistics_input_stats = cls(
            topic_uri=topic_uri,
            topic_url=topic_url,
            group_by_fields=group_by_fields,
        )

        topic_statistics_input_stats.additional_properties = d
        return topic_statistics_input_stats

...
T = TypeVar("T", bound="UpdateDataInputUpdate")


@_attrs_define
class UpdateDataInputUpdate:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        update_data_input_update = cls(
            skip_if_exists=skip_if_exists,
        )

        update_data_input_update.additional_properties = d
        return update_data_input_update

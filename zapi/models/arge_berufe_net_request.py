...
T = TypeVar("T", bound="ArgeBerufeNetRequest")


@_attrs_define
class ArgeBerufeNetRequest:
    """
    Attributes:
        id (Union[Unset, str]):
        url (Union[Unset, str]):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        arge_berufe_net_request.additional_properties = d
        return arge_berufe_net_request
